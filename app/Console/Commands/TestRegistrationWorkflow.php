...
class TestRegistrationWorkflow extends Command
{
  ...
  public function handle()
  {
    ...
    try {
      ...
      $candidature = \App\Models\Candidature::find($result['candidature']['id']);
      ...
      foreach ($alerts as $alert) {
        ...
        if ($alert->type === 'missing_documents') $hasDocAlert = true;
        if ($alert->type === 'payment_pending') $hasPaymentAlert = true;
      }
