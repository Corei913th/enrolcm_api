...
class DocumentObserver
{
    ...
    public function updated(Document $document): void
    {
        ...
        match ($nouveauStatut) {
            ...
            StatutVerificationDocument::REJETE => $this->notificationService->notifyDocumentRejected(
                $candidat,
                $document,
            ...
            StatutVerificationDocument::VALIDE => $this->handleDocumentValidation($document, $candidature, $candidat),
