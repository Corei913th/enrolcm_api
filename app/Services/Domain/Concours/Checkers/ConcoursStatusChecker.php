...
class ConcoursStatusChecker
{
   ...
   */
  public function getExamStartDate(Concours $concours): ?\Carbon\Carbon
  {
   ...
   * @return \Carbon\Carbon|null
   */
  public function getExamEndDate(Concours $concours): ?\Carbon\Carbon
  {
    return $concours->plannings()
      ->where('est_actif', true)
  ...
  public function getAvailablePlacesForSession(
    ...
    $query = $concours->belongsToMany(\App\Models\Filiere::class, 'concours_filiere')
