...
class NotificationService
{
   ...
   */
  public function notifyDocumentVerified(Candidat $candidat, \App\Models\Document $document): void
  {
    $utilisateur = $candidat->utilisateur;
   ...
   * @param string $motif
   */
  public function notifyDocumentRejected(Candidat $candidat, \App\Models\Document $document, string $motif): void
  {
    $utilisateur = $candidat->utilisateur;
  ...
  public function notifyCandidatureValidated(Candidat $candidat, Candidature $candidature): void
  {
    ...
    if ($this->canSendEmail($candidat)) {
      try {
        $ficheService = app(\App\Services\Infrastructure\Pdf\FicheInscriptionPdfService::class);
   ...
   */
  public function notifyResultsPublished(Candidat $candidat, Candidature $candidature, \App\Models\ResultatFinal $resultat): void
  {
    $utilisateur = $candidat->utilisateur;
