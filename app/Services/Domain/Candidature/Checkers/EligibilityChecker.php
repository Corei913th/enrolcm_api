    ...
    public function checkDocumentsStatus(Candidature $candidature): array
    {
        ...
        foreach ($documentsStatus as $docStatus) {
            if ($docStatus['est_obligatoire']) {
                if ($docStatus['statut'] === StatutVerificationDocument::NON_SOUMIS) {
                    $missing[] = $docStatus['nom'];
                } elseif ($docStatus['statut'] === StatutVerificationDocument::EN_ATTENTE) {
                    $pending[] = $docStatus['nom'];
                } elseif ($docStatus['statut'] === StatutVerificationDocument::REJETE) {
