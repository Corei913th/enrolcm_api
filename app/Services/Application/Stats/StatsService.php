...
use App\Models\{Candidat, Candidature, Paiement, Document, Concours, Centre, Ecole, Departement, Filiere, Niveau};
use App\Enums\{StatutCandidature, StatutPaiement, StatutVerificationDocument};
