...
class ConcoursEpreuveController extends Controller
{
     ...
     */
    public function attach(string $concoursId, Request $request): JsonResponse
    {
        $request->validate([
     ...
     */
    public function updateParams(string $concoursId, string $epreuveId, Request $request): JsonResponse
    {
        $request->validate([
            'date_epreuve' => 'nullable|date|after_or_equal:today',
            'heure_debut' => 'nullable|date_format:H:i',
