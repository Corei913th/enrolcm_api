...
class CandidatsExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, ShouldAutoSize
{
  ...
  public function map($candidature): array
  {
    return [
      ...
      $candidature->candidat->date_naissance_cand ? \Carbon\Carbon::parse($candidature->candidat->date_naissance_cand)->format('d/m/Y') : '',
