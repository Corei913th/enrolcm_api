...
class JournalPaiementsExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, ShouldAutoSize
{
  protected $filters;
  ...
  public function map($paiement): array
  {
    return [
      ...
      $paiement->date_verification ? \Carbon\Carbon::parse($paiement->date_verification)->format('d/m/Y H:i') : '',
