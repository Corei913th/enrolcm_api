...
class CandidatureServiceSyncTest extends TestCase
{
    ...
    /** @test */
    public function sync_status_with_payment_does_nothing_when_no_payment_exists()
    {
        // Arrange
    ...
    /** @test */
    public function sync_status_with_payment_updates_to_paiement_verifie_when_payment_verified_and_documents_not_complete()
    {
        // Arrange
    ...
    /** @test */
    public function sync_status_with_payment_updates_to_valide_when_payment_verified_and_documents_complete()
    {
        // Arrange
        $candidature = $this->createCandidatureWithPayment(StatutPaiement::VERIFIED);
    ...
    /** @test */
    public function sync_status_with_payment_maintains_status_when_payment_rejected()
    {
        // Arrange
    ...
    /** @test */
    public function sync_status_with_payment_maintains_status_when_payment_pending()
    {
        // Arrange
    ...
    /** @test */
    public function sync_status_with_payment_maintains_status_when_payment_pending_manual_review()
    {
        // Arrange
    ...
    /** @test */
    public function update_eligibility_status_updates_paiement_valide_flag()
    {
        // Arrange
        $candidature = $this->createCandidatureWithPayment(StatutPaiement::VERIFIED);
    ...
    /** @test */
    public function update_eligibility_status_sets_paiement_valide_to_false_when_payment_not_verified()
    {
        // Arrange
        $candidature = $this->createCandidatureWithPayment(StatutPaiement::PENDING);
    ...
    /** @test */
    public function update_eligibility_status_updates_documents_complets_flag()
    {
        // Arrange
        $candidature = $this->createCandidatureWithPayment(StatutPaiement::VERIFIED);
        $candidature->documents_complets = false;
